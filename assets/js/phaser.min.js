...
(function () {
  ...
  b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.8", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.defaultRenderOptions = {
    ...
    for (var a = b.BitmapText.fonts[this.fontName], c = new b.Point, d = null, e = [], f = 0, g = [], h = 0, i = this.fontSize / a.size, j = 0, k = 0; k < this.text.length; k++) {
      ...
      if (j = /(\s)/.test(this.text.charAt(k)) ? k : j, /(?:\r\n|\r|\n)/.test(this.text.charAt(k)))g.push(c.x), f = Math.max(f, c.x), h++, c.x = 0, c.y += a.lineHeight, d = null; else if (-1 !== j && this.maxWidth > 0 && c.x * i > this.maxWidth)e.splice(j, k - j), k = j, j = -1, g.push(lastLineWidth), f = Math.max(f, lastLineWidth), h++, c.x = 0, c.y += a.lineHeight, d = null; else {
        var m = a.chars[l];
    ...
    var p = this.children.length, q = e.length, r = this.tint || 16777215;
    this.textWidth = f * i, this.textHeight = (c.y + a.lineHeight) * i;
    var s = this.textWidth * this.anchor.x, t = this.textHeight * this.anchor.y;
    for (k = 0; q > k; k++) {
    ...
    var a = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAABAQMAAADD8p2OAAAAA1BMVEX/", b = "AAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==", c = new Image;
    c.src = a + "AP804Oa6" + b;
    var d = new Image;
    d.src = a + "/wCKxvRF" + b;
    ...
    var d = a.texture, e = b.CanvasTinter.canvas || document.createElement("canvas");
    ...
    if (0 !== d) {
      ...
      for (var e = 0; d > e; e++) {
        ...
        } else if (f.type === b.Graphics.RECT)c.rect(g.x, g.y, g.width, g.height), c.closePath(); else if (f.type === b.Graphics.CIRC)c.arc(g.x, g.y, g.radius, 0, 2 * Math.PI), c.closePath(); else if (f.type === b.Graphics.ELIP) {
  ...
  window.console || (window.console = {}, window.console.log = window.console.assert = function () {
  ...
  },c.StateManager.prototype.constructor = c.StateManager,c.Signal = function () {
  },c.Signal.prototype = {
    _bindings: null,
    _prevParams: null,
    memorize: !1,
    ...
    add: function (a) {
      ...
      for (this._i = this._len; this._i--;)if (this.plugins[this._i] === a)return a.destroy(), this.plugins.splice(this._i, 1), void this._len--
    }, removeAll: function () {
    ...
    if ("undefined" != typeof a) {
      a = a.split(".");
      var c = a.length;
      if ("undefined" == typeof b || null === b || "" === b)b = null; else if ("string" == typeof b) {
        b = b.split(".");
        var d = b.length
      }
      var e;
    ...
    if ("undefined" == typeof c && (c = !1), arguments.length <= 3)for (var d = 0; d < this.children.length; d++)(!c || c && this.children[d].exists) && a.call(b, this.children[d]); else {
    ...
    var d = this.removeChild(a), e = this._hash.indexOf(d);
    ...
    if ("undefined" == typeof a && (a = !1), "undefined" == typeof b && (b = !1), 0 !== this.children.length) {
      do {
        ...
        var c = this.removeChild(this.children[0]), d = this._hash.indexOf(c);
        -1 !== d && this._hash.splice(d, 1), a && c && c.destroy(!0)
    ...
    if ("undefined" == typeof b && (b = this.children.length - 1), "undefined" == typeof c && (c = !1), "undefined" == typeof d && (d = !1), 0 !== this.children.length) {
      ...
      for (var e = b; e >= a;) {
        ...
        var f = this.removeChild(this.children[e]), g = this._hash.indexOf(f);
        -1 !== g && this._hash.splice(g, 1), c && f && f.destroy(!0), this.cursor === this.children[e] && (this.cursor = null), e--
      }
      this.updateZ()
    }
    ...
    boot: function () {
      ...
      return this.moveCallbacks.push({callback: a, context: b}) - 1
    ...
    start: function (a, b) {
      ...
      if (this.isDragged = !0, this._draggedPointerID = a.id, this._pointerData[a.id].isDragged = !0, this.sprite.fixedToCamera)this.dragFromCenter ? (this.sprite.centerOn(a.x, a.y), this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y)) : this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y); else {
    ...
    destroyPhase: !1, destroy: function (a) {
  ...
  c.Component.FixedToCamera = function () {
    ...
    _frame: null, loadTexture: function (a, b, d) {
      b = b || 0, (d || "undefined" == typeof d) && this.animations && this.animations.stop(), this.key = a;
      var e = !0, f = !this.texture.baseTexture.scaleMode, g = !1;
  ...
  c.Button.prototype.clearFrames = function () {
    ...
    if (this.playStateSound(i), this.onInputUp && this.onInputUp.dispatch(this, b, c), !this.freezeFrames)if (this.forceOut)this.changeStateFrame(g); else {
    ...
    add: function (a) {
      ...
      if (("undefined" == typeof a || null === a) && (a = !1), ("undefined" == typeof b || null === b) && (b = !1), ("undefined" == typeof d || null === d) && (d = !1), a || b || d) {
        ...
        for (var f = c.Color.createColor(), g = e.y; g < e.bottom; g++)for (var h = e.x; h < e.right; h++)c.Color.unpackPixel(this.getPixel32(h, g), f, !0), a && (f.h = a), b && (f.s = b), d && (f.l = d), c.Color.HSLtoRGB(f.h, f.s, f.l, f), this.setPixel32(h, g, f.r, f.g, f.b, f.a, !1);
        return this.context.putImageData(this.imageData, 0, 0), this.dirty = !0, this
      }
    ...
    var i = e.fontSize + this.style.strokeThickness + this.padding.y, j = i * b.length, k = this._lineSpacing;
    ...
    return b ? {
      ...
      fontSize: b[4] || "medium",
      fontFamily: b[5]
    } : (console.warn("Phaser.Text - unparsable CSS font: " + a), {font: a})
    ...
    this.style = {align: this._align}, this.fontName = this._font, this.fontSize = this._fontSize, this.dirty = !0
    ...
    for (var l = this.offsetX, m = this.offsetY, n = 0, o = 0; o < f.length; o++) {
      var p = a.rnd.uuid(), q = this.frameData.addFrame(new c.Frame(o, l, m, this.characterWidth, this.characterHeight, "", p));
    ...
    for (var f = new c.Point, g = 0; g < a.length; g++)if (" " == a.charAt(g))b += this.characterWidth + e; else if (this.grabData[a.charCodeAt(g)] >= 0 && (this.stamp.frame = this.grabData[a.charCodeAt(g)], f.set(b, d), this.render(this.stamp, f, !1), b += this.characterWidth + e, b > this.width))break
  ...
  c.Math.degToRad = function (a) {
    ...
    to: function (a, b, d, e, f, g, h) {
      ...
      if ("undefined" == typeof c && (c = 0), -1 === c)for (var d = 0; d < this.timeline.length; d++)this.timeline[d][a] = b; else this.timeline[c][a] = b;
      return this
    }, delay: function (a, b) {
    ...
    to: function (a, b, c, d, e, f) {
      ...
      if (this.startTime = this.game.time.time + this.delay, this.dt = this.parent.reverse ? this.duration : 0, this.isRunning = this.delay > 0 ? !1 : !0, this.isFrom)for (var a in this.vStartCache)this.vStart[a] = this.vEndCache[a], this.vEnd[a] = this.vStartCache[a], this.parent.target[a] = this.vStart[a];
      ...
      for (var a in this.vEnd) {
        var b = this.vStart[a], d = this.vEnd[a];
    ...
    play: function (a, b, c) {
      ...
      var c;
      if ("undefined" == typeof b && (b = !1), "string" == typeof a)for (var d = 0; d < this._frames.length; d++)this._frameData.getFrame(this._frames[d]).name === a && (c = d); else if ("number" == typeof a)if (b)c = a; else for (var d = 0; d < this._frames.length; d++)this._frames[d] === c && (c = d);
    ...
    addFrame: function (a) {
      ...
      if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = []), "undefined" == typeof a || 0 === a.length)for (var d = 0; d < this._frames.length; d++)c.push(this._frames[d]); else for (var d = 0, e = a.length; e > d; d++)c.push(b ? this.getFrame(a[d]) : this.getFrameByName(a[d]));
      return c
    ...
    spriteSheet: function (a, b, d, e, f, g, h) {
      ...
      var e, f = new c.FrameData, g = b.frames, h = 0;
      for (var i in g) {
        var j = a.rnd.uuid();
    ...
    addCanvas: function (a, b, c) {
      ...
      this._tilemaps[a] = {url: b, data: c, format: d}, this._resolveURL(b, this._tilemaps[a])
      ...
      this._physics[a] = {url: b, data: c, format: d}, this._resolveURL(b, this._physics[a])
      ...
      this._text[a] = {url: b, data: c}, this._resolveURL(b, this._text[a])
    }, addJSON: function (a, b, c) {
      this._json[a] = {url: b, data: c}, this._resolveURL(b, this._json[a])
    }, addXML: function (a, b, c) {
      this._xml[a] = {url: b, data: c}, this._resolveURL(b, this._xml[a])
    ...
    setPreloadSprite: function (a, b) {
      ...
      if ("undefined" == typeof c && (c = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = 0), "undefined" == typeof f && (f = 0), c)this.addToFileList("bitmapfont", a, b, {
        ...
        this.addToFileList("bitmapfont", a, b, {xmlURL: null, xmlData: g, xSpacing: e, ySpacing: f})
      }
      return this
      ...
      switch (a.type) {
        ...
        case"spritesheet":
          ...
          break;
        case"textureatlas":
          if (null == a.atlasURL)this.game.cache.addTextureAtlas(a.key, a.url, a.data, a.atlasData, a.format); else if (d = !1, a.format == c.Loader.TEXTURE_ATLAS_JSON_ARRAY || a.format == c.Loader.TEXTURE_ATLAS_JSON_HASH)this.xhrLoad(a, this.transformUrl(a.atlasURL, a), "text", this.jsonLoadComplete); else {
    ...
    bitmapFont: function (a, b, c, d, e) {
      var f = {}, g = b.getElementsByTagName("info")[0], h = b.getElementsByTagName("common")[0];
      ...
      for (var i = b.getElementsByTagName("char"), j = 0; j < i.length; j++) {
        var k = parseInt(i[j].getAttribute("id"), 10), l = new PIXI.Rectangle(parseInt(i[j].getAttribute("x"), 10), parseInt(i[j].getAttribute("y"), 10), parseInt(i[j].getAttribute("width"), 10), parseInt(i[j].getAttribute("height"), 10));
        f.chars[k] = {
      ...
      for (j = 0; j < m.length; j++) {
        var n = parseInt(m[j].getAttribute("first"), 10), o = parseInt(m[j].getAttribute("second"), 10), p = parseInt(m[j].getAttribute("amount"), 10);
    ...
    soundHasUnlocked: function (a) {
      ...
      if (this._sound && this.isPlaying && !this.allowMultiple && (this.override || e))if (this.usingWebAudio)if ("undefined" == typeof this._sound.stop)this._sound.noteOff(0); else try {
        this._sound.stop(0)
      } catch (f) {
    ...
    setBounds: function (a, b, c, d) {
      ...
      if (this.intersects(a, b)) {
        ...
        if (0 === a.deltaX() && 0 === b.deltaX() ? (a.embedded = !0, b.embedded = !0) : a.deltaX() > b.deltaX() ? (d = a.right - b.x, d > e || a.checkCollision.right === !1 || b.checkCollision.left === !1 ? d = 0 : (a.touching.none = !1, a.touching.right = !0, b.touching.none = !1, b.touching.left = !0)) : a.deltaX() < b.deltaX() && (d = a.x - b.width - b.x, -d > e || a.checkCollision.left === !1 || b.checkCollision.right === !1 ? d = 0 : (a.touching.none = !1, a.touching.left = !0, b.touching.none = !1, b.touching.right = !0)), a.overlapX = d, b.overlapX = d, 0 !== d) {
          ...
          if (a.immovable || b.immovable)a.immovable ? b.immovable || (b.x += d, b.velocity.x = f - g * b.bounce.x, a.moves && (b.y += (a.y - a.prev.y) * a.friction.y)) : (a.x = a.x - d, a.velocity.x = g - f * a.bounce.x, b.moves && (a.y += (b.y - b.prev.y) * b.friction.y)); else {
            d *= .5, a.x = a.x - d, b.x += d;
      ...
      if (this.intersects(a, b)) {
        ...
        if (0 === a.deltaY() && 0 === b.deltaY() ? (a.embedded = !0, b.embedded = !0) : a.deltaY() > b.deltaY() ? (d = a.bottom - b.y, d > e || a.checkCollision.down === !1 || b.checkCollision.up === !1 ? d = 0 : (a.touching.none = !1, a.touching.down = !0, b.touching.none = !1, b.touching.up = !0)) : a.deltaY() < b.deltaY() && (d = a.y - b.bottom, -d > e || a.checkCollision.up === !1 || b.checkCollision.down === !1 ? d = 0 : (a.touching.none = !1, a.touching.up = !0, b.touching.none = !1, b.touching.down = !0)), a.overlapY = d, b.overlapY = d, 0 !== d) {
          ...
          if (a.immovable || b.immovable)a.immovable ? b.immovable || (b.y += d, b.velocity.y = f - g * b.bounce.y, a.moves && (b.x += (a.x - a.prev.x) * a.friction.x)) : (a.y = a.y - d, a.velocity.y = g - f * a.bounce.y, b.moves && (a.x += (b.x - b.prev.x) * b.friction.x)); else {
            d *= .5, a.y = a.y - d, b.y += d;
            var h = Math.sqrt(g * g * b.mass / a.mass) * (g > 0 ? 1 : -1), i = Math.sqrt(f * f * a.mass / b.mass) * (f > 0 ? 1 : -1), j = .5 * (h + i);
    ...
    updateBounds: function () {
      var a = Math.abs(this.sprite.scale.x), b = Math.abs(this.sprite.scale.y);
    ...
    return function a(b, c, d) {
      ...
      9: [function (a, b) {
        ...
        var d = (a("../shapes/Circle"), a("../shapes/Plane"), a("../shapes/Particle"), a("../collision/Broadphase")), e = (a("../math/vec2"), a("../utils/Utils"));
      ...
      11: [function (a, b) {
        ...
        var f = a("../math/vec2"), g = f.sub, h = f.add, i = f.dot, j = a("../utils/Utils"), k = a("../utils/TupleDictionary"), l = a("../equations/Equation"), m = a("../equations/ContactEquation"), n = a("../equations/FrictionEquation"), o = a("../shapes/Circle"), p = a("../shapes/Convex"), q = a("../shapes/Shape"), r = (a("../objects/Body"), a("../shapes/Rectangle"));
        b.exports = c;
        var s = f.fromValues(0, 1), t = f.fromValues(0, 0), u = f.fromValues(0, 0), v = f.fromValues(0, 0), w = f.fromValues(0, 0), x = f.fromValues(0, 0), y = f.fromValues(0, 0), z = f.fromValues(0, 0), A = f.fromValues(0, 0), B = f.fromValues(0, 0), C = f.fromValues(0, 0), D = f.fromValues(0, 0), E = f.fromValues(0, 0), F = f.fromValues(0, 0), G = f.fromValues(0, 0), H = f.fromValues(0, 0), I = f.fromValues(0, 0), J = f.fromValues(0, 0), K = f.fromValues(0, 0), L = [], M = f.create(), N = f.create();
        c.prototype.bodiesOverlap = function (a, b) {
          for (var c = M, d = N, e = 0, f = a.shapes.length; e !== f; e++) {
            {
              var g = a.shapes[e], h = a.shapeOffsets[e];
              a.shapeAngles[e]
            }
            a.toWorldFrame(c, h);
            for (var i = 0, j = b.shapes.length; i !== j; i++) {
              {
                var k = b.shapes[i], l = b.shapeOffsets[i];
                b.shapeAngles[i]
              }
          ...
          if (this.reuseObjects) {
            var f = this.contactEquations, g = this.frictionEquations, h = this.reusableFrictionEquations, i = this.reusableContactEquations;
        ...
        var Q = f.create(), R = f.create(), S = new r(1, 1);
        ...
        var T = f.create(), U = f.create(), V = f.create(), W = f.create();
        c.prototype[q.PARTICLE | q.CONVEX] = c.prototype[q.PARTICLE | q.RECTANGLE] = c.prototype.particleConvex = function (a, b, c, d, j, k, l, m, n) {
          ...
          var o = t, m = m || b.radius, n = n || i.radius;
          g(o, c, j);
          var p = m + n;
        ...
        {
          var X = new o(1), Y = f.create(), Z = f.create();
          f.create()
        }
        c.prototype[q.PLANE | q.CAPSULE] = c.prototype.planeCapsule = function (a, b, c, d, e, g, i, j, k) {
          ...
          var p = t, q = u, r = v, s = w, y = x, C = z, D = A, E = B, F = 0, o = "number" == typeof o ? o : 0, G = c.findSeparatingAxis(b, d, e, k, l, m, p);
          if (!G)return 0;
        ...
        var _ = f.fromValues(0, 0), ab = f.fromValues(0, 0), bb = f.fromValues(0, 0), cb = f.fromValues(0, 0), db = f.fromValues(0, 0), eb = f.fromValues(0, 0);
        c.findSeparatingAxis = function (a, b, d, e, h, i, j) {
          var k = null, l = !1, m = !1, n = _, o = ab, p = bb, q = cb, s = db, t = eb;
        ...
        var fb = f.fromValues(0, 0), gb = f.fromValues(0, 0), hb = f.fromValues(0, 0);
        ...
        var ib = f.create(), jb = f.create(), kb = f.create(), lb = f.create(), mb = f.create(), nb = f.create(), ob = f.create();
        c.prototype[q.CIRCLE | q.HEIGHTFIELD] = c.prototype.circleHeightfield = function (a, b, c, d, e, i, j, k, l, m) {
          var n = i.data, m = m || b.radius, o = i.elementWidth, p = jb, q = ib, r = mb, s = ob, t = nb, u = kb, v = lb, w = Math.floor((c[0] - m - j[0]) / o), x = Math.ceil((c[0] + m - j[0]) / o);
        ...
        var pb = f.create(), qb = f.create(), rb = f.create(), sb = new p([f.create(), f.create(), f.create(), f.create()]);
        c.prototype[q.RECTANGLE | q.HEIGHTFIELD] = c.prototype[q.CONVEX | q.HEIGHTFIELD] = c.prototype.convexHeightfield = function (a, b, c, d, e, g, h, i, j) {
          var k = g.data, l = g.elementWidth, m = pb, n = qb, o = rb, p = sb, q = Math.floor((a.aabb.lowerBound[0] - h[0]) / l), r = Math.ceil((a.aabb.upperBound[0] - h[0]) / l);
      ...
      12: [function (a, b) {
        ...
        b.exports = c;
        var e = a("../math/vec2"), f = a("../collision/RaycastResult"), g = a("../shapes/Shape"), h = a("../collision/AABB");
        c.prototype.constructor = c, c.CLOSEST = 1, c.ANY = 2, c.ALL = 4;
        var i = new h, j = [];
        c.prototype.intersectWorld = function (a, b) {
          return this.mode = b.mode || c.ANY, this.result = b.result || new f, this.skipBackfaces = !!b.skipBackfaces, this.collisionMask = "undefined" != typeof b.collisionMask ? b.collisionMask : -1, this.collisionGroup = "undefined" != typeof b.collisionGroup ? b.collisionGroup : -1, b.from && e.copy(this.from, b.from), b.to && e.copy(this.to, b.to), this.callback = b.callback || function () {
          }, this.hasHit = !1, this.result.reset(), this._updateDirection(), this.getAABB(i), j.length = 0, a.broadphase.aabbQuery(a, i, j), this.intersectBodies(j), this.hasHit
        };
        ...
        c.prototype.intersectBody = function (a, b) {
          ...
          if (!c || a.collisionResponse)for (var d = k, f = 0, g = a.shapes.length; g > f; f++) {
            var h = a.shapes[f];
          ...
          var f = this.from, g = d(f, this._direction, c);
          if (!(g > a.boundingSphereRadius)) {
            var h = this[a.type];
            h && h.call(this, a, b, c, e)
          }
        };
        var l = (e.create(), e.create(), e.create(), e.create(), e.create(), e.create(), e.create(), new f, e.create()), m = e.create(), n = e.create(), o = e.create(), p = e.create(), q = e.create(), r = e.create();
        c.prototype.intersectRectangle = function (a, b, c, d) {
          var f = -Number.MAX_VALUE, g = Number.MAX_VALUE, h = l, i = m, j = n, k = o, s = p, t = q, u = r;
        ...
        var s = e.create(), t = e.create(), u = e.create(), v = e.create(), w = e.create();
        c.prototype.intersectPlane = function (a, b, c, d) {
          var f = this.from, g = this.to, h = this._direction, i = s, j = t, k = u, l = v, m = w;
        ...
        c.prototype.intersectCircle = function (a, b, c, d) {
          var f = this.from, g = this.to, h = a.radius, i = Math.pow(g[0] - f[0], 2) + Math.pow(g[1] - f[1], 2), j = 2 * ((g[0] - f[0]) * (f[0] - c[0]) + (g[1] - f[1]) * (f[1] - c[1])), k = Math.pow(f[0] - c[0], 2) + Math.pow(f[1] - c[1], 2) - Math.pow(h, 2), l = Math.pow(j, 2) - 4 * i * k, m = x, n = y;
          if (!(0 > l))if (0 === l)e.lerp(m, f, g, l), e.sub(n, m, c), e.normalize(n, n), this.reportIntersection(n, m, a, d, -1); else {
            var o = (-j - Math.sqrt(l)) / (2 * i), p = (-j + Math.sqrt(l)) / (2 * i);
          ...
          var h = this.from, i = this.to, j = e.distance(h, b), k = this.result;
        ...
        var z = e.create(), A = e.create()
      }, {"../collision/AABB": 7, "../collision/RaycastResult": 13, "../math/vec2": 31, "../shapes/Shape": 45}],
      13: [function (a, b) {
        function c() {
      ...
      }, {"../collision/Broadphase": 8, "../utils/Utils": 50}],
      15: [function (a, b) {
        function c(a, b, c, e) {
      ...
      }, {"../equations/Equation": 23, "../math/vec2": 31, "../utils/Utils": 50, "./Constraint": 15}],
      17: [function (a, b) {
        function c(a, b, c) {
      ...
      }, {"../equations/AngleLockEquation": 21, "../equations/Equation": 23, "../math/vec2": 31, "./Constraint": 15}],
      18: [function (a, b) {
        function c(a, b, c) {
          c = c || {}, d.call(this, a, b, d.LOCK, c);
          var g = "undefined" == typeof c.maxForce ? Number.MAX_VALUE : c.maxForce, h = (c.localAngleB || 0, new f(a, b, -g, g)), i = new f(a, b, -g, g), j = new f(a, b, -g, g), k = e.create(), l = e.create(), m = this;
      ...
      }, {"../equations/Equation": 23, "../math/vec2": 31, "./Constraint": 15}],
      19: [function (a, b) {
        function c(a, b, c) {
        ...
        c.prototype.update = function () {
          ...
          if (this.upperLimitEnabled && s > c)g.scale(e.normalA, i, -1), g.sub(e.contactPointA, j, h.position), g.sub(e.contactPointB, k, o.position), g.scale(n, i, c), g.add(e.contactPointA, e.contactPointA, n), -1 === a.indexOf(e) && a.push(e); else {
            var u = a.indexOf(e);
            -1 !== u && a.splice(u, 1)
          }
          if (this.lowerLimitEnabled && d > s)g.scale(f.normalA, i, 1), g.sub(f.contactPointA, j, h.position), g.sub(f.contactPointB, k, o.position), g.scale(n, i, d), g.sub(f.contactPointB, f.contactPointB, n), -1 === a.indexOf(f) && a.push(f); else {
            var u = a.indexOf(f);
            -1 !== u && a.splice(u, 1)
          }
      ...
      20: [function (a, b) {
        ...
        c.prototype = new d, c.prototype.constructor = c, c.prototype.setLimits = function (a, b) {
          ...
          var a = this.bodyA, b = this.bodyB, c = this.pivotA, d = this.pivotB, e = this.equations, f = (e[0], e[1], e[0]), g = e[1], m = this.upperLimit, n = this.lowerLimit, o = this.upperLimitEquation, p = this.lowerLimitEquation, q = this.angle = b.angle - a.angle;
      ...
      }, {"../math/vec2": 31, "../objects/Body": 32, "../utils/Utils": 50}],
      24: [function (a, b) {
        function c(a, b, c) {
      ...
      }, {"../math/vec2": 31, "../utils/Utils": 50, "./Equation": 23}],
      25: [function (a, b) {
        function c(a, b, c) {
      ...
      27: [function (a, b) {
        ...
        b.exports = c, c.prototype = {
          constructor: c, on: function (a, b, c) {
      ...
      }, {"../equations/Equation": 23, "./Material": 29}],
      29: [function (a, b) {
        function c(a) {
      ...
      32: [function (a, b) {
        ...
        var d = a("../math/vec2"), e = a("poly-decomp"), f = a("../shapes/Convex"), g = a("../collision/AABB"), h = a("../events/EventEmitter");
        ...
        c.prototype.updateAABB = function () {
          ...
          for (var a = this.shapes, b = this.shapeOffsets, c = a.length, e = 0, f = 0; f !== c; f++) {
            var g = a[f], h = d.length(b[f]), i = g.boundingRadius;
            h + i > e && (e = h + i)
          }
          ...
          if (this.type === c.STATIC || this.type === c.KINEMATIC)this.mass = Number.MAX_VALUE, this.invMass = 0, this.inertia = Number.MAX_VALUE, this.invInertia = 0; else {
            var a = this.shapes, b = a.length, e = this.mass / b, f = 0;
            if (this.fixedRotation)this.inertia = Number.MAX_VALUE, this.invInertia = 0; else {
              for (var g = 0; b > g; g++) {
                var h = a[g], i = d.squaredLength(this.shapeOffsets[g]), j = h.computeMomentOfInertia(e);
                f += j + e * i
              }
        ...
        var l = (d.fromValues(0, 0), d.fromValues(0, 0)), m = d.fromValues(0, 0), n = d.fromValues(0, 0);
        c.prototype.adjustCenterOfMass = function () {
          var a = l, b = m, c = n, e = 0;
          d.set(b, 0, 0);
          for (var f = 0; f !== this.shapes.length; f++) {
            var g = this.shapes[f], h = this.shapeOffsets[f];
        ...
        var q = d.create(), r = d.create(), s = d.create(), t = d.create();
        c.prototype.integrateToTimeOfImpact = function (a) {
          ...
          var b, c = this.angularVelocity * a, e = d.length(s), f = 1, g = this;
        ...
        }, c.sleepyEvent = {type: "sleepy"}, c.sleepEvent = {type: "sleep"}, c.wakeUpEvent = {type: "wakeup"}, c.DYNAMIC = 1, c.STATIC = 2, c.KINEMATIC = 4, c.AWAKE = 0, c.SLEEPY = 1, c.SLEEPING = 2
      }, {
        "../collision/AABB": 7,
      ...
      }, {"../math/vec2": 31, "../utils/Utils": 50, "./Spring": 35}],
      34: [function (a, b) {
        function c(a, b, c) {
      ...
      39: [function (a, b) {
        function c(a, b) {
          ...
          if (b)for (var c = 0; c < b.length; c++) {
            ...
            var h = a[c], i = a[(c + 1) % a.length], j = e.create();
      ...
      }, {"../math/polyk": 30, "../math/vec2": 31, "./Shape": 45, "poly-decomp": 5}],
      40: [function (a, b) {
        function c(a, b) {
          if (b = e.defaults(b, {
              maxValue: null,
        ...
        var d = a("./Shape"), e = (a("../math/vec2"), a("../utils/Utils"));
      ...
      }, {"../math/vec2": 31, "../utils/Utils": 50, "./Shape": 45}],
      41: [function (a, b) {
        function c(a) {
      ...
      44: [function (a, b) {
        function c(a, b) {
          ...
          var c = [d.fromValues(-a / 2, -b / 2), d.fromValues(a / 2, -b / 2), d.fromValues(a / 2, b / 2), d.fromValues(-a / 2, b / 2)], g = [d.fromValues(1, 0), d.fromValues(0, 1)];
      ...
      }, {"../math/vec2": 31, "./Convex": 39, "./Shape": 45}],
      45: [function (a, b) {
        function c(a) {
      ...
      46: [function (a, b) {
        ...
        b.exports = c, c.prototype = new f, c.prototype.constructor = c, c.prototype.solve = function (a, b) {
          this.sortEquations();
          var f = 0, i = this.iterations, j = this.frictionIterations, k = this.equations, l = k.length, m = Math.pow(this.tolerance * l, 2), n = b.bodies, o = b.bodies.length, p = (e.add, e.set, this.useZeroRHS), q = this.lambda;
      ...
      }, {"../equations/FrictionEquation": 24, "../math/vec2": 31, "../utils/Utils": 50, "./Solver": 47}],
      47: [function (a, b) {
        function c(a, b) {
      ...
      }, {"../events/EventEmitter": 27, "../utils/Utils": 50}],
      48: [function (a, b) {
        function c() {
        ...
        b.exports = c, c.prototype.tick = function () {
          for (var a = this.overlappingShapesLastState, b = this.overlappingShapesCurrentState, c = a.keys.length; c--;) {
            var d = a.keys[c], e = a.getByKey(d), f = b.getByKey(d);
      ...
      51: [function (a, b) {
        ...
        c.prototype.getBodies = function (a) {
          ...
          for (var d = 0; d !== c.length; d++) {
            var f = c[d];
            -1 === e.indexOf(f.bodyA.id) && (b.push(f.bodyA), e.push(f.bodyA.id)), -1 === e.indexOf(f.bodyB.id) && (b.push(f.bodyB), e.push(f.bodyB.id))
          }
          return b
      ...
      52: [function (a, b) {
        ...
        var d = (a("../math/vec2"), a("./Island")), e = a("./IslandNode"), f = a("../objects/Body");
        b.exports = c, c.getUnvisitedNode = function (a) {
          ...
          var e = this.queue;
          for (e.length = 0, e.push(a), a.visited = !0, this.visit(a, b, d); e.length;)for (var g, h = e.pop(); g = c.getUnvisitedNode(h.neighbors);)g.visited = !0, this.visit(g, b, d), g.body.type === f.DYNAMIC && e.push(g)
          ...
          for (var j = 0; j !== g.length; j++) {
            var k = g[j], h = b.indexOf(k.bodyA), l = b.indexOf(k.bodyB), m = f[h], n = f[l];
      ...
      }, {"../math/vec2": 31, "../objects/Body": 32, "./Island": 51, "./IslandNode": 53}],
      53: [function (a, b) {
        function c(a) {
      ...
      54: [function (a, b) {
        function c(a) {
          ...
          }, this.overlappingShapesLastState = {keys: []}, this.overlappingShapesCurrentState = {keys: []}, this.overlapKeeper = new s
        }

        {
          var d = a("../solver/GSSolver"), e = (a("../solver/Solver"), a("../collision/NaiveBroadphase"), a("../collision/Ray")), f = a("../math/vec2"), g = a("../shapes/Circle"), h = (a("../shapes/Rectangle"), a("../shapes/Convex")), i = (a("../shapes/Line"), a("../shapes/Plane")), j = a("../shapes/Capsule"), k = a("../shapes/Particle"), l = a("../events/EventEmitter"), m = a("../objects/Body"), n = (a("../shapes/Shape"), a("../objects/LinearSpring"), a("../material/Material")), o = a("../material/ContactMaterial"), p = (a("../constraints/DistanceConstraint"), a("../constraints/Constraint"), a("../constraints/LockConstraint"), a("../constraints/RevoluteConstraint"), a("../constraints/PrismaticConstraint"), a("../constraints/GearConstraint"), a("../../package.json"), a("../collision/Broadphase"), a("../collision/SAPBroadphase")), q = a("../collision/Narrowphase"), r = a("../utils/Utils"), s = a("../utils/OverlapKeeper"), t = a("./IslandManager");
        ...
        var v = (f.create(), f.create(), f.create(), f.create(), f.create(), f.create(), f.create()), w = f.fromValues(0, 0), x = f.fromValues(0, 0), y = (f.fromValues(0, 0), f.fromValues(0, 0));
        ...
        c.prototype.internalStep = function (a) {
          this.stepping = !0;
          var b, d, e = this, g = this.doProfiling, h = this.springs.length, i = this.springs, j = this.bodies, k = this.gravity, l = this.solver, n = this.bodies.length, o = this.broadphase, p = this.narrowphase, q = this.constraints, s = v, t = (f.scale, f.add), u = (f.rotate, this.islandManager);
          ...
          for (var x = 0, H = C.length; x !== H; x += 2)for (var I = C[x], J = C[x + 1], K = 0, L = I.shapes.length; K !== L; K++)for (var M = I.shapes[K], N = I.shapeOffsets[K], O = I.shapeAngles[K], P = 0, Q = J.shapes.length; P !== Q; P++) {
            var R = J.shapes[P], S = J.shapeOffsets[P], T = J.shapeAngles[P], U = this.defaultContactMaterial;
          ...
          if (g && (d = performance.now(), e.lastStepTime = d - b), this.emitImpactEvent && this.has("impact"))for (var _ = this.impactEvent, x = 0; x !== p.contactEquations.length; x++) {
          ...
          if (this.sleepMode === c.BODY_SLEEPING)for (x = 0; x !== n; x++)j[x].sleepTick(this.time, !1, a); else if (this.sleepMode === c.ISLAND_SLEEPING && this.islandSplit) {
          ...
          if (this.stepping)this.bodiesToBeRemoved.push(a); else {
            ...
            -1 !== b && (r.splice(this.bodies, b, 1), this.removeBodyEvent.body = a, a.resetConstraintVelocity(), this.emit(this.removeBodyEvent))
          }
        ...
        var A = f.create(), B = f.fromValues(0, 0), C = f.fromValues(0, 0);
        c.prototype.hitTest = function (a, b, c) {
          c = c || 0;
          var d = new m({position: a}), e = new k, l = a, n = 0, o = A, p = B, q = C;
          d.addShape(e);
          for (var r = this.narrowphase, s = [], t = 0, u = b.length; t !== u; t++)for (var v = b[t], w = 0, x = v.shapes.length; w !== x; w++) {
            var y = v.shapes[w], z = v.shapeOffsets[w] || p, D = v.shapeAngles[w] || 0;
          ...
          this.setGlobalEquationParameters({stiffness: a})
        }, c.prototype.setGlobalRelaxation = function (a) {
          this.setGlobalEquationParameters({relaxation: a})
        };
        var D = new e;
    ...
    createBodyCallback: function (a, b, c) {
      ...
      if ("undefined" == typeof a)for (var c = this.data.shapes.length - 1; c >= 0; c--)this.data.shapes[c].collisionMask = b; else a.collisionMask = b
    }, setCollisionGroup: function (a, b) {
      var c = this.getCollisionMask();
      if ("undefined" == typeof b)for (var d = this.data.shapes.length - 1; d >= 0; d--)this.data.shapes[d].collisionGroup = a.mask, this.data.shapes[d].collisionMask = c; else b.collisionGroup = a.mask, b.collisionMask = c
    }, clearCollision: function (a, b, c) {
      if ("undefined" == typeof a && (a = !0), "undefined" == typeof b && (b = !0), "undefined" == typeof c)for (var d = this.data.shapes.length - 1; d >= 0; d--)a && (this.data.shapes[d].collisionGroup = null), b && (this.data.shapes[d].collisionMask = null); else a && (c.collisionGroup = null), b && (c.collisionMask = null);
      a && (this.collidesWith.length = 0)
    }, collides: function (a, b, c, d) {
      if (Array.isArray(a))for (var e = 0; e < a.length; e++)-1 === this.collidesWith.indexOf(a[e]) && (this.collidesWith.push(a[e]), b && this.createGroupCallback(a[e], b, c)); else-1 === this.collidesWith.indexOf(a) && (this.collidesWith.push(a), b && this.createGroupCallback(a, b, c));
      var f = this.getCollisionMask();
      if ("undefined" == typeof d)for (var e = this.data.shapes.length - 1; e >= 0; e--)this.data.shapes[e].collisionMask = f; else d.collisionMask = f
      ...
      if ("undefined" == typeof b)for (var c = this.data.shapes.length - 1; c >= 0; c--)this.data.shapes[c].material = a; else b.material = a
    ...
    create: function (a, b, c, d, e, f) {
      ...
      for (var k, l = 0, m = this.objects[a].length; m > l; l++)if (this.objects[a][l].gid === b) {
      ...
      if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = this.currentLayer), "undefined" == typeof d && (d = !0), b)this.collideIndexes.push(a); else {
  ...
  c.Component.Core.install.call(c.TilemapLayer.prototype, l), c.TilemapLayer.sharedCopyCanvas = null, c.TilemapLayer.ensureSharedCopyCanvas = function () {
    ...
    parse: function (a, b, d, e, f, g) {
      ...
      d.tilesets = s;
      for (var v = {}, w = {}, f = 0; f < a.layers.length; f++)if ("objectgroup" === a.layers[f].type) {
        v[a.layers[f].name] = [], w[a.layers[f].name] = [];
        for (var x = 0, p = a.layers[f].objects.length; p > x; x++)if (a.layers[f].objects[x].gid) {
          var y = {
    ...
    } else this.emitParticle() && (this._counter++, -1 !== this._flowTotal && this._counter >= this._flowTotal && (this.on = !1)); else this.emitParticle() && (this._counter++, this._quantity > 0 && this._counter >= this._quantity && (this.on = !1));
